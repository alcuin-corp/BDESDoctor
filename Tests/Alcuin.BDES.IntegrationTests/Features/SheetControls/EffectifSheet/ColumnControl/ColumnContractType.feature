...
Scenario: Processing file with invalid cell content in column 'Type de contrat' should faild
	...
	Then I should found the following Error messages
		| Message                                                                                                                                                                                                                |
		| Dans l'onglet 'effectifs', la colonne 'Type de contrat' contient une donnée non reconnue [invalid data] (valeurs autorisées [CDI, CDD, CIE, Alternance, Professionnalisation, CTT, CUI, CAE]). |